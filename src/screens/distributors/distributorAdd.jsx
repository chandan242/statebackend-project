...
import {createDistributor,uploadDocDistributor} from "../../apis/distributor";
...
export const AddDistributor = () => {
  ...
  return (
    <>
      <p className="form-heading-para">ADD DISTRIBUTORS</p>
      <hr />
          ...
          <form>
            <div className="form-tag">
              ...
              <div className="form-rows">
                {formFieldUI("Distributor Code", "code", "text", "*")}
                {formFieldUI("Distributor Name", "name", "text", "*")}
